...
def run(a):
    if a=="check":
        subprocess.call([r"Check_Activation.cmd"])
    elif a=="isodown":
        webbrowser.open("https://www.heidoc.net/php/Windows-ISO-Downloader.exe")
    elif a=="hwidact":
        subprocess.call([r"HWID_Activation.cmd"])
    elif a=="kms38act":
        subprocess.call([r"KMS38_Activation.cmd"])
    elif a=="onlkms":
        onlkmsact()
    elif a=="oldkmsact":
        subprocess.call([r"Old-act\Activate.cmd"])
    elif a=="oldkmsren":
        subprocess.call([r"Old-act\Renewal_Setup.cmd"])
    elif a=="oldkmsunin":
        subprocess.call([r"Old-act\Uninstall.cmd"])
    elif a=="hwidr":
        os.system(r"notepad.exe Readmefiles\hwid_readme.txt")
    elif a=="kms38r":
        os.system(r"notepad.exe Readmefiles\kms38_readme.txt")
    elif a=="extractoemr":
        os.system(r"notepad.exe Readmefiles\extractoem_readme.txt")
    elif a=="kms38prot":
        os.system(r"notepad.exe Readmefiles\kms38prot_readme.txt")
    elif a=="oldkmsr":
        os.system(r"notepad.exe Readmefiles\oldact_readme.txt")
    elif a=="exOEM":
        subprocess.call([r"Extras\Extract_OEM_Folder.cmd"])
    elif a=="win10install":
        subprocess.call([r"Extras\OEMRET-Install_W10_Key.cmd"])
    elif a=="win10change":
        subprocess.call([r"Extras\OEMRET-Change_W10_Edition.cmd"])
    elif a=="kms38prot":
        subprocess.call([r"Extras\Protect_Unprotect-KMS38.cmd"])
    elif a=="abbodi":
        webbrowser.open("https://forums.mydigitallife.net/threads/74197/")
    elif a=="credits":
        os.system(r"notepad.exe Readmefiles\Credits.txt")
